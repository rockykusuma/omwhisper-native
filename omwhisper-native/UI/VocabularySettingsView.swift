    ...
    var body: some View {
        ...
        return PorcelainPage {
            ...
            PorcelainSection {
                ...
                Text("Corrects misheard and split-up versions of your custom words. On by default, and does nothing until you add a word above.")
                    .font(.caption)
                    .foregroundStyle(Color.Porcelain.dim)
                Text("Examples: \"app cast\" → \"appcast\" · \"whisper kit\" → \"WhisperKit\" · \"Vercell\" → \"Vercel\"")
                    .font(.caption)
                    .foregroundStyle(Color.Porcelain.dim)
